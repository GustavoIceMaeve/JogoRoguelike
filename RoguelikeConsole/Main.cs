namespace RoguelikeConsole
{
    class Inicio
    {
        ...
        Personagem heroi = new Personagem(nome,10, inventario);
        heroi.ClasseDoPersonagem(resposta);
            ...
            { 
                ...
                else if(resposta == 3)
                {
                    ...
                    else
                    {
                        ...
                        Console.Clear();
                        heroi.Status();
                        Console.WriteLine($"Você ganhou em {rodadas} rodadas!! Parabéns {heroi.GetNome()}!");
                        sairDoJogo = false;
                        Console.ReadLine();
                    }
                }
